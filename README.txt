...
6. Go through the other Coming Soon Express sections to customize your Coming Soon landing page.  Change the background image and text content easily.
7. To add a Contact or Opt-In Form to your coming soon page, you must first download your preferred Forms plugin for Wordpress. We have developed Coming Soon Express to be compatible with Ninja Forms.
...
1. New 'Coming Soon Express' menu in the WP Customizer
2. Ensure 'Enable Functionality' is turned on
3. Adding a Ninja Forms widget to the CSX Widget
4. Default 'Coming Soon Express' Page
5. Example Personal Branding Landing Page
6. Example 'Under Construction' Page
